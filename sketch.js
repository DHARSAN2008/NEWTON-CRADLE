...
function setup() {
   ...
   roof=new Roof(500,200,200,25)

	bob1=new Bob(390,400,40)
	bob2=new Bob(420,400,40)
	bob3=new Bob(460,400,40)
	bob4=new Bob(500,400,40)
	bob5=new Bob(540,400,40)
...
function keyPressed(){
   ...
   if(keyCode === UP_ARROW){
     ...
     Matter.Body.applyForce(bob1.body,bob1.body.position,{x:-10,y:-1});
   }
 }
